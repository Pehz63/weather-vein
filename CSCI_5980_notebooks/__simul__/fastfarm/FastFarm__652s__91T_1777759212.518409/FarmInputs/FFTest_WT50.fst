...
"NRELOffshrBsline5MW_Onshore_ServoDyn_WT50.dat" ServoFile     - Name of file containing control and electrical-drive input parameters (quoted string)
...
3             DT_Out        - Time step for tabular output (s) (or "default")
